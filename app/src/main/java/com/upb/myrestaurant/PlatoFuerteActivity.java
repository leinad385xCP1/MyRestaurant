...
public class PlatoFuerteActivity extends ListActivity {
    ...
    private void setData(){
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.ing_plato_fuerte1);
        productoActual1.precioProducto =  this.getResources().getString(R.string.prec_plato_fuerte1);
        productoActual1.imagenProducto = R.drawable.pizza;
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.ing_plato_fuerte2);
        productoActual2.precioProducto =  this.getResources().getString(R.string.prec_plato_fuerte2);
        productoActual2.imagenProducto = R.drawable.burger;
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.ing_plato_fuerte3);
        productoActual3.precioProducto =  this.getResources().getString(R.string.prec_plato_fuerte3);
        productoActual3.imagenProducto = R.drawable.hotdog;
